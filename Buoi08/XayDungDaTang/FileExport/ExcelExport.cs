...
namespace FileExport
{
    public class ExcelExport
    {
        ...
        public const string T_DanhMucDiem = "DanhMucDiem";
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
         ...
         //   string path = Global.AppPath + Constants.FOLDER_TEMPLATES + Constants.CHAR_FLASH; //+ Constants.FOLDER_EXCELS + Constants.CHAR_FLASH;
            ...
            switch (viewName)
            {
                ...
                case T_DanhMucDiem:
                    arrByte = File.ReadAllBytes("DanhMucDiem.xls").ToArray();
                    break;
                #endregion
            }
            // Get stream
        ...
        public bool ExportDiem(List<Diem> dataSource, ref string fileName, bool isPrintPreview)
        {
            ...
            return OutSimpleReport(dataSource, replacer, "DanhMucDiem", isPrintPreview, ref fileName);
        }
