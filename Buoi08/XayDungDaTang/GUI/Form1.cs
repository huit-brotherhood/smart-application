...
namespace GUI
{
    public partial class Form1 : Form
    {
        ...
        void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            string hehe = "DanhMucDiem";
            var rowSelected = dataSinhVien.CurrentRow;
            DiemBLL diemBLL = new DiemBLL();
          List<Diem> list  = diemBLL.GetDiemSinhVien(rowSelected.Cells[0].Value.ToString());
          ep.ExportDiem(list, ref hehe, false);
            System.Diagnostics.Process.Start(hehe);
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            var sv = (SinhVien)dataSinhVien.CurrentRow.DataBoundItem;
            we.ThongTinSinhVien(sv);
